...
> Display: shown only when cem_role = principal.
...
> Display: shown only when cem_principal = yes.
...
> Display: shown only when cem_role = reseller.
...
> Display: shown only when cem_reseller = yes.
...
### 1c.3 ERP-Wide AI Features — Others  _(Mandatory)_
> Display: shown only when "Others — please specify" is ticked.

Describe your additional AI feature(s).

_Answer:_ Answer: __________________________________________________

## §2 · Module scope gate

### 2.1 Which ERP modules does your solution provide?  _(Mandatory)_
> Gating: select at least 3.

Tick each ERP module your solution covers. An "Others" option does not count toward the minimum.
...
### 100.5 Finance Module — AI Features — Others  _(Mandatory)_
> Display: shown only when "Others — please specify" is ticked.
...
### 101.4 Sales & CRM Module — AI Features — Others  _(Mandatory)_
> Display: shown only when "Others — please specify" is ticked.
...
### 102.4 Supply Chain & Inventory Management Module — AI Features — Others  _(Mandatory)_
> Display: shown only when "Others — please specify" is ticked.
...
### 103.4 Human Resources Management Module — AI Features — Others  _(Mandatory)_
> Display: shown only when "Others — please specify" is ticked.
...
### 104.4 Manufacturing Operations Management — AI Features — Others  _(Mandatory)_
> Display: shown only when "Others — please specify" is ticked.
...
### 108.4 Asset Management Module — AI Features — Others  _(Mandatory)_
> Display: shown only when "Others — please specify" is ticked.
...
### 106.4 Field Service Management Module — AI Features — Others  _(Mandatory)_
> Display: shown only when "Others — please specify" is ticked.
...
### 105.4 Fleet Management Module — AI Features — Others  _(Mandatory)_
> Display: shown only when "Others — please specify" is ticked.
...
### 107.4 Project Management Module — AI Features — Others  _(Mandatory)_
> Display: shown only when "Others — please specify" is ticked.
...
### 3.3 Externally-Integrated Modules  _(Preferred)_
